...
class Person(object):
    ...
    def __init__(self, email, firstname, lastname, location, telephone, image, password=None):
    ...
    def deploy(cls):
        ...
        if authenticated:
            ...
            if tx_receipt is not None and tx_receipt.contractAddress is not None and tx_receipt.status == 1:
                ...
                contract = ContractModel(contract_address=tx_receipt.contractAddress, abi=json.dumps(contract_compilation['abi']))
